...
Config.AmmoTypes = {
    ...
    ['AMMO_REPEATER']                    = { maxAmmo = 200, refill = 12, group = `group_repeater` },
    ['AMMO_REPEATER_HIGH_VELOCITY']      = { maxAmmo = 200, refill = 12, group = `group_repeater` },
    ['AMMO_REPEATER_SPLIT_POINT']        = { maxAmmo = 100, refill = 12, group = `group_repeater` },
    ['AMMO_REPEATER_EXPRESS']            = { maxAmmo = 200, refill = 12, group = `group_repeater` },
    ['AMMO_REPEATER_EXPRESS_EXPLOSIVE']  = { maxAmmo = 10,  refill = 10, group = `group_repeater` },
